package com.bestbrand.lib_xtsize.layout
 ...
 * 2020/3/31
 */
open class XtConstraintLayout @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr), IXtView {
    private var delegate = XtViewDelegate(this)
